        ...
        body: Column(
          ...
          children: [
            ...
            Column(
              children: [
                Text(
                  ManagerStrings.pleaseEnterYourPhoneAndPassword,
                  style: TextStyle(
                    color: ManagerColors.gray,
                  ),
                ),
                Text(
                  ManagerStrings.toContinue,
                  style: TextStyle(color: ManagerColors.gray),
                ),
              ],
            ),
            SizedBox(
            ...
            Row(
              ...
              children: [
                Text(
                  ManagerStrings.dontHaveAccount,
                  style: TextStyle(
                    fontSize: ManagerFontSizes.s16,
                    fontWeight: ManagerFontWeight.regular,
                  ),
